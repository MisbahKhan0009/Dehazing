...
class EchocardiographyDataset(Dataset):
    ...
    def __init__(self, dataset_path, csv_path, mode='train', transform=None, use_roi=True, patient_split=None, image_size=(256, 256)):
        """
        Args:
            dataset_path: Path to the dataset folder containing clean, noisy, noisy_roi
            csv_path: Path to the dataset mapping CSV file
...
# Removed duplicate EchocardiographyDataset class
